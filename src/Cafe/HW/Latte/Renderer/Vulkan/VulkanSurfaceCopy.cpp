...
static const char* vsShaderSrc_FP16 =
	...
	"// Keep push constants in FP32 to match C++ struct layout\n"
	...
	"\n"
	"void main(){\n"
	"    f16vec2 tPOS;  // Use FP16 for ALU only\n"
	"    switch(gl_VertexIndex)\n"
	"    {\n"
	"    case 0: tPOS = f16vec2(uf_pushConstants.vertexOffsets[0]); break;\n"
	"    case 1: tPOS = f16vec2(uf_pushConstants.vertexOffsets[1]); break;\n"
	"    case 2: tPOS = f16vec2(uf_pushConstants.vertexOffsets[3]); break;\n"
	"    case 3: tPOS = f16vec2(uf_pushConstants.vertexOffsets[0]); break;\n"
	"    case 4: tPOS = f16vec2(uf_pushConstants.vertexOffsets[2]); break;\n"
	"    case 5: tPOS = f16vec2(uf_pushConstants.vertexOffsets[3]); break;\n"
	"    }\n"
